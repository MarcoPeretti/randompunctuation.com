    ...
    <div className="prose prose-neutral dark:prose-invert">
      ...
      <h3 id="bio">Super Short Bio</h3>
        ...
        <ul>
          ...
          <li>I may sometimes struggle to patiently listen until the end and will propose a &lsquo;solution&rsquo;. I am a problem solver by nature, and sometimes can act instinctively. </li>
