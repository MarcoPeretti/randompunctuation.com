export const metadata = {
  ...
  description:
    "Notes on Elegant Puzzle: Systems of Engineering, by Will Larson. Collection of tips and best practices.",
  keywords:
    ["Book Review", "An Elegant Puzzle", "Will Larson", "Systems of Engineering"],

alternates: {
canonical: "/blog/an-elegant-puzzle",
},
};
...
- **Domineering** - most common _when those making decisions are abstracted from the consequences of the decisions_. Eg. architecture groups in which the members write little code.
