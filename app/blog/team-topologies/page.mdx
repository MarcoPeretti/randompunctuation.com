export const metadata = {
  ...
  description: "Brief summary of Team Topologies",
  keywords: ["Team Topologies", "team structure", "scaling", "stream-aligned", "cognitive load"],

alternates: {
canonical: "/blog/team-topologies",
},
};

# Navigating Organizational Complexity: A brief summary of Team Topologies

<br />
One of the common challenges faced by successful organisations is how to ensure an
optimal team structure over time. All too often, however, reorgs are messy and fail
