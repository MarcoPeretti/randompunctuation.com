export const metadata = {
  ...
  description: 'Interview Performance is not a reliable indicator of Work Performance.',
  keywords: ["Interview Performance", "Hiring Performance", "Hiring Best Practices", "Hiring", "Startups", "Scaling"],

alternates: {
canonical: "/blog/interview-performance-vs-job-performance",
},
};
...
Each candidate should be **independently screened by at least two people**, but new interviewers should always be paired with more experienced ones.
