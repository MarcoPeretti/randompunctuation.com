...
async function BlogLink({ slug, name }) {
  ...
  return (
    <a
      href={`/blog/${slug}`}
      className="border border-neutral-200 dark:border-neutral-700 bg-neutral-50  dark:bg-neutral-800 rounded-sm flex items-center justify-between px-3 py-4 w-full"
    >
