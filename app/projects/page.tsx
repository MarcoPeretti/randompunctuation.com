  ...
  return (
    <section>
      <h1 className="font-bold text-2xl mb-8 tracking-tighter">
        ...
        Here below some projects I have worked on recently.
        ...
        This research project aimed at centralizing applications’ battery usage as well as ways to reduce their consumptions. The Windows client is written in C++ and a mix of Go and Javascript on the backend. The frontend was a static website deployed to CloudFront.  
        ...
        <h3 id="source">Ransomware protection</h3>

        This is an older project dating back to 2017 where I developed a Windows kernel driver PoC that calcultated the entropy of each file as it was written to disk and rejected the ones over a given threshold. 
        <br></br>
